                            ...
                            <div class="outer-space-top" id="<?php echo $artsItem['art_id']?>">
                                <div class="icons-top">
                                    ...
                                    <svg class="scale" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M1.5 1.50003H18.5V18.5H1.5V1.50003Z" stroke="#F3EEDB"/>
                                        <path d="M3 17L9 17L3 11V17Z" fill="#F3EEDB"/>
                                        <path d="M17 2.99999L11 3.00003L17 9.00004L17 2.99999Z" fill="#F3EEDB"/>
                                    </svg>
                                </div>
                                <div class="stat-top">
